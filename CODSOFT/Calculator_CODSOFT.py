...
lab_res=Label(root,width=25,height=2,text="",font=("arial",30))
lab_res.pack()

Button(root,text="C", width=5, height=1, font=("arial",30,"bold"),bd=1,fg="#fff",bg="#3697f5",command=lambda:delete()).place(x=10,y=100)
Button(root,text="/", width=5, height=1, font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda:display("/")).place(x=150,y=100)
